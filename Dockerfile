...
ADD ./ /dashing
RUN apt-get update
RUN apt-get install build-essential procps libxml2-dev libxslt1-dev nodejs sqlite3 libsqlite3-dev libc-ares2 ruby-json ruby-multi-json ruby-oj ruby-yajl -y -f
